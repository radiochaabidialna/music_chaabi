    ...
    itemCard.innerHTML = `
      <div class="card">
        ...
        <div class="card-body">
          ...
          <button class="btn btn-secondary" onclick="toggleLike('${item.categorie.toLowerCase()}', ${item.id}, 'categories', ${item.views})">Like</button>
        </div>
      </div>
    `;
...
async function toggleLike(type, id, section, currentViews) {
